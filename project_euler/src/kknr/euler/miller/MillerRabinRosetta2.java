package kknr.euler.miller;

import java.math.BigInteger;

/**
 * http://rosettacode.org/wiki/Miller%E2%80%93Rabin_primality_test#Java
 */
public class MillerRabinRosetta2
{
    ...
    public static boolean isPrime(BigInteger n) {
    	...
    	if (n.compareTo(BigInteger.valueOf(Integer.MAX_VALUE)) <= 0) {
    		return MillerRabinDk.isPrime(n.intValue());
    	}
